...
export function FonctionnaliteFormPage() {
  ...
  const { fonctionnalites, createFonctionnalite, updateFonctionnalite } = useFonctionnalites();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (isEditing && id) {
        await updateFonctionnalite(id, formData.nom.trim(), formData.description.trim() || undefined);
      } else {
        await createFonctionnalite(formData.nom.trim(), applicationId, formData.description.trim() || undefined);
      }
